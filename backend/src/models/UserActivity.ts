...
const UserActivitySchema = new Schema<IUserActivity>({
  ...
  action: {
    ...
    enum: [
      ...
      'community_post',
      'community_comment',
      'community_forum_created',
      'community_forum_updated',
      'community_forum_deleted',
      'community_forum_joined',
      'community_post_created',
      'community_post_updated',
      'community_post_deleted',
      'community_post_moderated',
      'community_comment_created',
      'community_comment_moderated',
      'community_comment_deleted',
      'community_reply_created',
      'community_meeting_created',
      'community_meeting_updated',
      'community_meeting_canceled',
      'community_meeting_deleted',
      'community_meeting_notification_sent',
      'community_meeting_rsvp_joined',
      'community_meeting_rsvp_left',
      'admin_login',
      'admin_logout',
