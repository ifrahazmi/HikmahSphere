...
self.addEventListener('fetch', (event) => {
  ...
  // Startup connectivity must always hit the network; a cached success would
  // incorrectly report an offline installed PWA as connected.
  if (url.pathname === '/online-check.txt') return;
